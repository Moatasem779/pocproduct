...
public class ProductPOCModuleDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ProductPOCModuleDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
