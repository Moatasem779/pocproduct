...
public class ProductPOCModuleDbContext :
    AbpDbContext<ProductPOCModuleDbContext>,
    ...
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(ProductPOCModuleConsts.DbTablePrefix + "YourEntities", ProductPOCModuleConsts.DbSchema);
