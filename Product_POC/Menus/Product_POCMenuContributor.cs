...
namespace Product_POC.Menus;

public class Product_POCMenuContributor : IMenuContributor
{
    ...
    {
        var l = context.GetLocalizer<Product_POCResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                Product_POCMenus.Home,
                l["Menu:Home"],
                "/",
                icon: "fas fa-home",
                order: 1
